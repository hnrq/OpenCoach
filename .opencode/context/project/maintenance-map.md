...
| `coaching/lookup/exercisedb-optimization.md` | `opencoach-programmer.md` (MVI) | Added 2026-04-12; Batch & Deduct strategy |
...
| `coaching/lookup/exercisedb-vocabulary.json` | `opencoach-programmer.md` (reads/writes) | Vocabulary cache for ExerciseDB. 30-day TTL. |
...
| `coach-fetch-exercisedb-vocabulary.ts` | ExerciseDB API | `coaching/lookup/exercisedb-vocabulary.json` | None (Fetches taxonomy) |
